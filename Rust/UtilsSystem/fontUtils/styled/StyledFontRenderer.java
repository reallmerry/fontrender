package fish.xenos.UtilsSystem.fontUtils.styled;

import com.mojang.blaze3d.matrix.MatrixStack;
import com.mojang.blaze3d.platform.GlStateManager;
import fish.xenos.UtilsSystem.fontUtils.Wrapper;
import fish.xenos.UtilsSystem.renderUtils.ColorUtil;
        ...
        for (ITextComponent textComponent : text.getSiblings()) {
            ...
            for (ITextComponent textComponent1 : textComponent.getSiblings()) {
                ...
                if (textComponent1.getStyle().getColor() != null) {
                    rgb = ColorUtil.IntColor.rgb(textComponent1.getStyle().getColor().getColor());
                    r1 = rgb[0];
                    r2 = rgb[1];
                    r3 = rgb[2];
                    r4 = 1;
